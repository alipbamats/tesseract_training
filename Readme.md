#### Состояние box файлов
	1) Балъгояб даптар [Мух1амад Бисавг1алиев]: 1-15 файлов
	2) Т1асарищарал асарал [Мух1амад Сулиманов]: 1-32 файлов
	3) Меседил ччуг1а [Мух1амадрасул Дациев]: 1-31 файлов
...
#### Создание box файла из изображения
	 ...
	 for i in *.png; do tesseract $i  ${i%.*} -l rus --tessdata-dir /usr/share/tesseract-ocr/4.00/tessdata/ batch.nochop makebox; done
